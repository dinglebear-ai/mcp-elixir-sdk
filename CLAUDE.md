# Plexus - Claude CLI Instructions
...
**Related packages**:
- `adk_ex` at `/workspace/elixir_code/adk_ex/` — Elixir ADK (Agent Development Kit). Will use the `plexus` client via an `ADK.Tool.McpToolset` adapter.
